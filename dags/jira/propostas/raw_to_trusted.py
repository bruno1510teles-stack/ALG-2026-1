...
def raw_to_trusted(access_params=None, **kwargs):
    ...
    nome_padronizado = {
        ...
        ('GLAUCIANE OLIVEIRA', 'GLAUCIELE OLIVEIRA', 'GLAUCIELE RODRIGUES', 'GLAUCIELE') : 'GLAUCIELE OLIVEIRA',
        ...
        ('PEDRO VINICIUS', 'PEDRO ALVES', 'PEDRO'): 'PEDRO VINICIUS',
        'PORTAL ARCELOR': 'OUTROS',
        'PRISCILA YURI': 'OUTROS',
        ('PRISCILLA MORAES', 'PRISCILLA COSTA'): 'PRISCILLA COSTA',  
        ('RAFAEL CANTAGALLI', 'RAFAEL'): 'RAFAEL CANTAGALLI',
        'RAFAELA - ASUS': 'OUTROS',
        ('ROGERIO', 'ROGERIO FRIAS'): 'OUTROS',
        ('ROSEMEIRE DIAS', 'ROSEMEIRE FERREIRA') : 'OUTROS',
        ('TALITA LIANDRA DA SILVA RODRIGUES', 'TALITA RODRIGUES', 'TALITA', 'TALIRA RODRIGUES') : 'TALITA LIANDRA',
        'THAIS DAS NEVES' : 'OUTROS',
        ('TIAGO CARVALHO', 'TIAGO.CARVALHO@ALPE.COM.BR', 'ANTONIO TIAGO REBOUÇAS DE CARVALHO') : 'TIAGO CARVALHO',
        'VANESSA LINO': 'OUTROS',
        ('WILMA CARLA ROCHA SANTOS', 'WILMA SANTOS', 'WILMA', 'WILMA CARLA'): 'WILMA SANTOS',
        'JOEL DONIZETTI APARECIDO': 'OUTROS',
        ('COMERCIAL CONEXÃO', 'COMERCIAL - CONEXÃO') : 'OUTROS',
        ('JESSICA PATTARO', 'JESSICA KONNO PATTARO', 'JÉSSICA PATTARO', 'JESSICA PATARRO'): 'JESSICA PATTARO',
        ('LEONARDO BOFF', 'LEONARDO SILVA', 'LEONARDO DA SILVA', 'LEONARDO'): 'LEONARDO BOFF',
        ('VANUZA SILVA', 'VANUZA VIAL'): 'OUTROS',
        ('VICENTE DOUGLAS', 'VICENTE MOURA', 'VICENTE DOUGLAS RIBEIRO DE MOURA'): 'VICENTE DOUGLAS',
        ('NATALIA GOLFETO', 'NATÁLIA GOLFETO', 'NATÁLIA ALMEIDA', 'NATALIA', 'NATÁLIA GOLFETO DE ALMEIDA') : 'NATALIA GOLFETO',
        ('MAIRZE CARNEIRO', 'MAIRZE DUTRA', 'MAIRZE', 'MAIRZE CARNEIRO E DUTRA'): 'MAIRZE CARNEIRO',
        ('JEANINI REISER'): 'OUTROS',
        ('NICOLAS OLIVEIRA', 'NICOLAS SANTOS DE OLIVEIRA', 'NICOLAS'): 'NICOLAS OLIVEIRA',
    ...
    mesa = [
        ...
        'ANA BEATRIZ RODRIGUES ANDRADE', 'ALEXANDRE DE MEDEIROS', 'ANNA CAROLINA DULCETTI TRINDADE'      
    ]
    ...
    outros = [
        ...
        'ADRIANA BARBOSA DE OLIVEIRA', 'EDNEIA COMIN DA SILVA', 'MARISANGELA DE MENEZES CALDAS', 'GUSTAVO COLLARES FACCINI TREVISAN',
        'ANTONIO TIAGO REBOUÇAS DE CARVALHO', 'CELIO TORRECILHA FILHO', 'NATÁLIA GOLFETO DE ALMEIDA', 'ROBSON GIMENEZ', 'CASSIO FILIPE ALVES ESTEVES'
    ]
    ...
    pgids_excluidos = [
        ...
        'PHILIPMORRIS', 'ROGE', 'SEUGIL', 'ULTRACHEESE', 'YANDEH', 'HORTMIX']
