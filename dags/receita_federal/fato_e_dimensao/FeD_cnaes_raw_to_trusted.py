...
day_to_process_cnaes = f"{RECEITA_FEDERAL_CNAES_FOLDER}year=2024/month=6/"#'#year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
