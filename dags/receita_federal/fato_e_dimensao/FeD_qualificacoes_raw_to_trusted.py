...
day_to_process_qualificacoes = f"{RECEITA_FEDERAL_QUALIFICACOES_FOLDER}year=2024/month=7/day=26/"#year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
