...
# SCRIPTS
from scripts.hp_externa.mesa.mesa_variaveis_detalhada import transform_data_to_refined
...
day_to_process = f"{BOLETOS_ALPE_TRUSTED_FOLDER}year={yesterday.year}/month={str(yesterday.month)}/day=13/"
