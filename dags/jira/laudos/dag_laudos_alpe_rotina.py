...
from laudos_alpe_rotina import trusted_incremental
...
with DAG(
    ...
    laudos_alpe_rotina = PythonOperator(
        task_id='laudos_incremental_trusted',
        python_callable= trusted_incremental,
