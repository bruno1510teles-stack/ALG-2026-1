...
# SCRIPTS
from scripts.receita_federal.receita_fato_dimensao.estabelecimentos_raw_to_trusted import estabelecimento_to_trusted
...
day_to_process_estabelecimentos = f"{RECEITA_FEDERAL_ESTABELECIMENTOS_FOLDER}year=2024/month=6/"#'#year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
...
def receita_federal_estabelecimentos():
    # init & finish task
    ...
    def estabelecimentos(current_files_estabelecimento):
        ...
        estabelecimento_to_trusted(current_files_estabelecimento, access_params)

    unique_clients = estabelecimentos(list_today_files_estabelecimento.output)
