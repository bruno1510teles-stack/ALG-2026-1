...
sys.path.append('/opt/airflow/dags/repo/dags/serasa')
from rating_mais_recente_serasa import rating_mais_recente_serasa
...
with DAG(
    ...
    rating_task  = PythonOperator(
        ...
        python_callable= rating_mais_recente_serasa,
