...
# Criando conexão
def naturezas_juridicas_to_trusted(files_list_naturezas_juridicas, access_params):

    # Variaveis Conexão
    BUCKET_SOURCE_RAW = "receita-federal"
    BUCKET_SOURCE_TRUSTED = "receita-federal"
    TRUSTED_FOLDER = "naturezas_juridicas/"
    ...
    # Importando dados de NATUREZAS JURIDICAS
    print(f'IMPORTANDO NATUREZAS JURIDICAS {psutil.virtual_memory()._asdict()}')

    for file_name in files_list_naturezas_juridicas:
