...
# Criando conexão
def qualificacoes_to_trusted(files_list_qualificacoes, access_params):

    # Variaveis Conexão
    BUCKET_SOURCE_RAW = "receita-federal"
    BUCKET_SOURCE_TRUSTED = "receita-federal"
    TRUSTED_FOLDER = "qualificacoes/"
    ...
    # Importando dados de qualificacoes
    print(f'IMPORTANDO qualificacoes {psutil.virtual_memory()._asdict()}')

    for file_name in files_list_qualificacoes:
