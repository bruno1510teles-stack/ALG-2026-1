...
# SCRIPTS
from scripts.receita_federal.contato_pessoas_e_organizacoes import transform_receita_to_contato
...
def contato_receita_federal():
    ...
    def contato_receita_federal(current_files_estabelecimento):
        ...
        transform_receita_to_contato(current_files_estabelecimento, access_params)

    unique_clients = contato_receita_federal(list_today_files_estabelecimento.output)

    # run order
    init_data_load >> list_today_files_estabelecimento >> check_files >> unique_clients >> finish_data_load

contato_receita_federal()