...
def retorno_diario_trusted (access_params=None, **kwargs):
    ...
    retorno_final['data_arquivo'] = pd.to_datetime(retorno_final['data_arquivo']).dt.floor('D')
    retorno_final['data_arquivo'] = retorno_final['data_arquivo'].dt.tz_localize('UTC', nonexistent='NaT', ambiguous='NaT')
