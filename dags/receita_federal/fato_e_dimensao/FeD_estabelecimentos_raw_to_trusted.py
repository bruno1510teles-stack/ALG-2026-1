...
day_to_process_estabelecimentos = f"{RECEITA_FEDERAL_ESTABELECIMENTOS_FOLDER}year=2024/month=6/" #year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
