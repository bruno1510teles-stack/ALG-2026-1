...
"""
    ...
    # Ordenar por data (mais recente primeiro) e pegar a primeira linha por cnpj_raiz
    ...
    df_final_cenario2['data_criado'] = pd.to_datetime(df_final_cenario2['data_criado'])
    df_final_cenario2['data_resolvido'] = pd.to_datetime(df_final_cenario2['data_resolvido'])
