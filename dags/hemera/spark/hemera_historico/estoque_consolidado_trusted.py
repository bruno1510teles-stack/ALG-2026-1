...
def estoque_consolidado_trusted (access_params=None, **kwargs):
    ...
    df_join = df_join.withColumn(
        ...
        when(trim(col("Grupo")) == "OLHAR SACADO", 
            ...
            .when(col("nome_sacado") == "G&B AUTO PECAS ALTERNATIVAS LTDA - EM RECUPERACAO JUDICIAL", "Tradicional")
            .when(col("nome_sacado") == "G E B AUTO PECAS ALTERNATIVAS LTDA", "Tradicional")
