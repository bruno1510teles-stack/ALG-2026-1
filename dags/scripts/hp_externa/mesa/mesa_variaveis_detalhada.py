...
# Chamando as variáveis
    ...
    faixas_desejadas = ['01_ate_5_dias', '02_6_10_dias', '03_11_15_dias', '04_16_30_dias', '05_31_60_dias', '06_61_90_dias', '07_acima_90_dias']
    # Após a pivotagem dos dados, preencha os valores ausentes com zeros
    valor_vencido_mensal = valor_vencido_mensal.reindex(columns=['documento', 'fornecedor', 'safra'] + faixas_desejadas, fill_value=None)
