...
day_to_process= f"{BOLETOS_ALPE_RAW_FOLDER}year=2023/month=12/day=1"
...
def boleto_alpe_to_trusted_dez_1():
    # init & finish task
    ...
    def transform_raw_to_trusted(current_files):
        ...
        print(f"fist file is { current_files[0] }")
        print(f"last file as { current_files[-1] }")
