...
day_to_process_naturezas_juridicas = f"{RECEITA_FEDERAL_NATUREZAS_JURIDICAS_FOLDER}year=2024/month=7/day=26/"#year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
