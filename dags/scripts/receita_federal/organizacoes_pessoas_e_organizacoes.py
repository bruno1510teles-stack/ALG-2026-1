...
def transform_receita_to_organizacoes(files_list_estabelecimento, files_list_empresa, access_params):
    ...
    df_empresa_organizacoes = df_empresa[['CNPJ BÁSICO', 'RAZÃO SOCIAL / NOME EMPRESARIAL', 'CAPITAL SOCIAL DA EMPRESA', 'PORTE DA EMPRESA']]
    
    df_organizacoes = df_estabelecimentos_organizacoes.merge(df_empresa_organizacoes, how='left',  on='CNPJ BÁSICO')
