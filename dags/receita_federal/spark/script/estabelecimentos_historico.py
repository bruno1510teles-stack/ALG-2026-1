...
def estabelecimentos_to_trusted(spark):
    ...
    PATH = "estabelecimentos/year=2025/month=03/"
    
    print("Lendo Pasta...")
    file_path = PATH
    print(f"Lendo todos os arquivos de s3a://{BUCKET_SOURCE}/{file_path}")
    ...
    target_path = f"s3a://bureaus/receita-federal/estabelecimentos_historico/year={ano}/month={mes}"
