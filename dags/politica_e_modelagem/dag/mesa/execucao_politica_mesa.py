...
from politica_e_modelagem.politica.mesa import politica_mesa
...
# Definindo a DAG
with DAG(
    dag_id='politica_mesa',
    start_date=days_ago(1),
    schedule_interval=None,
    default_args=default_args,
    tags=['politica_mesa']  # DAG só será acionada manualmente pela API
) as dag:
    ...
    politica = PythonOperator(
        ...
        python_callable=politica_mesa.execucao_politica,
        op_kwargs={'access_params': access_params},
        provide_context=True
    )
