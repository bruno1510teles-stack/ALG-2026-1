...
from segmentacao_cnae import excel_to_deltalake
...
with DAG(
    ...
    excel_to_deltalake = PythonOperator(
        task_id='excel_to_deltalake',
        python_callable = excel_to_deltalake.transforma_excel_deltalake_cnae,
