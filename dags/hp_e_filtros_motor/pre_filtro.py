...
# SCRIPTS
from scripts.hp_externa_e_filtros_motor.motor.pre_filtro import pre_filtro
...
def pre_filtro_to_refined():
    ...
    # run order
    init_data_load >> unique_clients >> finish_data_load

pre_filtro_to_refined()