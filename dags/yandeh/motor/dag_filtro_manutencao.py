...
from yandeh.motor import filtro_manutencao
...
# Definindo a DAG
with DAG(
    dag_id='filtro_manutencao_yandeh',
    start_date=days_ago(1),
    schedule_interval = "0 10 * * *",
    default_args=default_args,
    tags=['etl', 'motor', 'yandeh'],
    max_active_runs=1
) as dag:
    ...
    trusted_to_refined = PythonOperator(
        ...
        python_callable=filtro_manutencao.def_filtro_manutencao_yandeh,
