...
day_to_process_estabelecimento = f"{RECEITA_FEDERAL_ESTABELECIMENTOS_FOLDER}year=2024/month=4/" #f"{RECEITA_FEDERAL_ESTABELECIMENTOS_FOLDER}year={yesterday.year}/month={str(yesterday.month)}/"
