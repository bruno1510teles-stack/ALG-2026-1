...
def boletos_raw_to_trusted(access_params=None,  **kwargs):
	...
	where 
		...
		and bt.codigo_cedente not in (12, 188, 6910, 14099, 40585, 99241, 101880, 13974, 14688, 105372, 109619, 109151, 107738, 108454, 108455, 10798, 109485, 123326, 109485, 112294, 130500)
