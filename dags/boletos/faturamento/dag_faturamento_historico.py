...
with DAG(
    ...
    faturamento_historico_trusted = PythonOperator(
        task_id='faturamento_historico_trusted',
        python_callable=faturamento_historico.faturamento_historico_to_trusted,
