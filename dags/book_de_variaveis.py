...
# SCRIPTS
from scripts.hp_externa.motor.variaveis_motor import transform_data_to_refined
...
day_to_process = f"{BOLETOS_ALPE_TRUSTED_FOLDER}year=2024/month=03/day=12/"
...
def book_de_variaveis():
    ...
    @task()
    def book_de_variaveis(current_files):
    ...
    unique_clients = book_de_variaveis(list_today_files.output)
