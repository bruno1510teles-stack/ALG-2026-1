...
# SCRIPTS
from scripts.receita_federal.situacao_cadastral_pessoas_e_organizacoes import transform_receita_to_situacao_cadastral
...
def situacao_cadastral_receita_federal():
    # init & finish task
    ...
    def situacao_cadastral_receita_federal(current_files_estabelecimento):
        ...
        transform_receita_to_situacao_cadastral(current_files_estabelecimento, access_params)

    unique_clients = situacao_cadastral_receita_federal(list_today_files_estabelecimento.output)

    # run order
    init_data_load >> list_today_files_estabelecimento >> check_files >> unique_clients >> finish_data_load

situacao_cadastral_receita_federal()