...
day_to_process_natureza_juridica = f"{RECEITA_FEDERAL_NATUREZA_JURIDICA_FOLDER}year=2024/month=5/day=24/" #year={yesterday.year}/month={yesterday.month}/day={yesterday.day}/"
